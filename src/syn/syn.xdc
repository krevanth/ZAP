...
set_input_delay -clock [get_clocks i_clk] -min -add_delay 2.500 [get_ports i_reset]
set_input_delay -clock [get_clocks i_clk] -min -add_delay 2.500 [get_ports i_wb_ack]
set_input_delay -clock [get_clocks i_clk] -max -add_delay 2.500 [get_ports {i_wb_dat[*]}]
set_input_delay -clock [get_clocks i_clk] -max -add_delay 2.500 [get_ports i_fiq]
set_input_delay -clock [get_clocks i_clk] -max -add_delay 2.500 [get_ports i_irq]
set_input_delay -clock [get_clocks i_clk] -max -add_delay 2.500 [get_ports i_reset]
set_input_delay -clock [get_clocks i_clk] -max -add_delay 2.500 [get_ports i_wb_ack]
