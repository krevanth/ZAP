...
| Average MIPS@MHz                                                                                                                                                                                                                                                                               | 102MIPS@140MHz (ARM code)                                                                                   |
...
* A 4-state bimodal branch predictor that predicts the outcome of immediate branches and branch-and-link instructions. The branch memory is 2-bit wide and is direct mapped. Aliasing is possible due to absence of a tag field.&#x20;
  * Note that the branch RAM  does not specify the target address. This does result in a moderate branch penalty since the prediction cannot be made until after the decode stage.
