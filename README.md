...
| **Property**               | **Value**                                                                                                                                                                                                                                                         |
| -------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Performance                | 150MHz @ xc7a75tcsg324-3 <br/>When synthesized with Vivado 2021.2 Build 3367213 with `synth_design` issued with High Performance mode.<br/><br/>100 DMIPS @ 150MHz with cache enabled. **Cache must be enabled, and utilized effectively, for peak performance.** |
